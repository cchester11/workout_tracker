...
SECRET_KEY = 'django-insecure-1g!vsj01sevxbudq!2-e6u7@yt!sm9$36_gs37kab%lez4vu0f'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DATABASE_PASSWORD'),  # Add this line if you have a password
